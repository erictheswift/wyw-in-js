 ...
 * themselves.
 *
 * Reduced from fibery-ui's help-menu/workspace-status.tsx (two
 * `cx(textClasses.X, css``)` consts followed by an interpolated `containerStyle`),
 * where seven interpolations fail under `strategy: "static"`.
 */
